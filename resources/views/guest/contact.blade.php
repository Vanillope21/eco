            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-2 bg-white rounded-lg shadow p-8 mb-8 lg:mb-0">
                    ...
                    <form action="{{ url('/contact') }}" method="POST" class="space-y-4">
                        ...
                        <button type="submit" class="w-full md:w-auto px-8 py-3 bg-ecogreen text-gray-900 rounded-lg font-semibold shadow hover:bg-ecoorange hover:text-ecogreen transition text-lg">Send Message</button>
                    </form>
                </div>
                <!-- Contact Information -->
                <div class="bg-ecogreen rounded-lg shadow p-8 text-gray-900 flex flex-col gap-6">
