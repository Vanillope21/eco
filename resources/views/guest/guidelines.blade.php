...
<body class="bg-ecogreen-50 text-gray-900 font-sans">
    ...
    <main class="max-w-5xl mx-auto py-12 px-4">
        ...
        <section class="text-center mt-10">
            ...
            <a href="{{ route('register') }}" class="px-8 py-3 bg-ecogreen text-white rounded-lg font-semibold shadow hover:bg-ecoorange hover:text-ecogreen transition text-lg mr-3">Register Now</a>
